...
class FieldSelectionTest extends TestCase
{
    ...
    private function studyProgram(string $code, Province $province, City $city, Institution $institution, AcademicField $field, CourseType $courseType): StudyProgram
    {
        $year = ExamYear::query()->firstOrCreate(['year' => 1404], ['is_active' => true]);
        $group = ExamGroup::query()->firstOrCreate(['slug' => 'tajrobi'], ['name' => 'تجربی']);
