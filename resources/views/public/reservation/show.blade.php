            ...
            <div class="reservation-brand">
                ...
                <div class="reservation-brand__content">
                    ...
                    <div class="reservation-brand__subtitle">
                        مدیریت رزرو مشاوره انتخاب رشته
                    </div>
            ...
            <div class="hero-actions">
                ...
                @if($contactPhoneHref)
                    ...
                    <a
                        ...
                        class="hero-action hero-action--soft"
                    >
                ...
                <div>
                    ...
                    @if($reservation->paymentCard)
                        ...
                        <div class="payment-card-copy-wrap">
                            ...
                            <button
                                type="button"
                                class="copy-card-number js-copy-card"
        ...
        <div class="reservation-contact__text">
            ...
            @if($contactPhone)
                ...
                @if($contactPhoneHref)
                    ...
                    <a
                        class="reservation-contact__phone ltr"
                        href="tel:{{ $contactPhoneHref }}"
                    >
                        {{ $contactPhone }}
                    </a>
                    ...
                    <div class="student-form-grid">
                        ...
                        @if(in_array('score', $missing, true))
                            ...
                            <div class="student-field">
                                ...
                                <input
                                    ...
                                    value="{{ old('score') }}"
                                    class="student-input"
                                    placeholder="تراز خود را وارد کنید"
                                    required
                                >
                        ...
                        <div class="student-field student-field--full">
                            ...
                            <textarea
                                ...
                                placeholder="اگر توضیحی برای مشاور دارید اینجا بنویسید..."
        ...
        <section class="student-action-card">
            ...
            <div class="student-action-card__body">
                ...
                @if($studentReportCard)
                    ...
                    <div
                        class="reservation-notice reservation-notice--success"
                    ...
                    <a
                        ...
                        class="student-btn student-btn--outline"
                    ...
                    >
                        ...
                        <div class="student-upload">
                            ...
                            <input
                                ...
                                data-preview-target="report-card-preview"
                                required
                            >
    ...
    @if(
        ...
        <section class="student-action-card">
            ...
            <div class="student-action-card__body">
                ...
                <div
                    class="reservation-notice reservation-notice--info"
                    style="margin-bottom: 12px;"
                >
                ...
                @if($payment?->rejection_reason)
                    ...
                    <div
                        class="reservation-notice reservation-notice--danger"
                        style="margin-bottom: 12px;"
                    >
